...
import { clearErrors, registerUser } from './accountSlice';
...
export default function Register() {
    ...
    return (
        <div className="flex items-center justify-center h-screen px-2 md:px-10 lg:px-0">
            <div className="sm:flex flex-col md:grid md:grid-cols-2 bg-[rgb(var(--div))]/20 backdrop-filter bg-clip-padding backdrop-blur-md border-[rgb(var(--border))]/6 border rounded-lg shadow-lg lg:w-[60%] lg:h-[90vh] overflow-hidden">
                <div>
                            ...
                            <div className="w-full mt-auto mb-auto">
                                <div className="flex flex-col gap-y-5 w-full pt-4">
                                    <div className="grid grid-cols-2 gap-x-3 w-full">
                                        <div className="flex flex-col gap-y-2">
                                            <label htmlFor="firstName" className="font-semibold">Ad</label>
                                            ...
                                            })} placeholder="Adınızı Giriniz" className="border-gray-400 border rounded-lg p-2 outline-none w-full transition-all duration-500 focus:scale-[103%] focus:border-black" />
                                            {errors.firstName && <p className="text-red-500 text-sm">{errors.firstName.message?.toString()}</p>}
                                        </div>
                                        <div className="flex flex-col gap-y-2">
                                            <label htmlFor="lastName" className="font-semibold">Soyad</label>
                                            ...
                                            })} placeholder="Soyadınızı Giriniz" className="border-gray-400 border rounded-lg p-2 outline-none w-full transition-all duration-500 focus:scale-[103%] focus:border-black" />
                                    ...
                                    <div className="grid grid-cols-2 gap-x-3 w-full">
                                        ...
                                        <div className="flex flex-col gap-y-2">
                                            <label htmlFor="phoneNumber" className="font-semibold">Telefon Numarası</label>
                                ...
                                <div className="flex flex-col gap-y-12">
                                    ...
                                    <div className="flex flex-col text-center">
                                        <p className="text-center text-gray-500">Zaten hesabınız var mı?</p>
                                        <Link to="/login" className="text-center text-gray-500 underline">Giriş Yap</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
